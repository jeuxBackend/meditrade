...
{/* Search and Add Button */}
        ...
        <div className='mt-6'>
          ...
          <div className='grid md:grid-cols-3 mt-3 grid-cols-2 gap-4'>
            <div className=' flex justify-between items-center shadow border border-[#f0f0f1] rounded-lg p-3'>
              <p className='font-[400] text-[25px]'>Scalpel</p>
              <img src={MenuImg} className='w-8 '/>
            </div>
            <div className=' flex justify-between items-center shadow border border-[#f0f0f1] rounded-lg p-3'>
              <p className='font-[400] text-[25px]'>Scalpel</p>
              <img src={MenuImg} className='w-8 '/>
