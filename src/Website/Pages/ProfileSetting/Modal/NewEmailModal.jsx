...
function NewEmailModal({ openNewEmailModal, closeNewEmailModal,  handleNext, }) {
  if (!openNewEmailModal) return null;
...
NewEmailModal.propTypes = {
  openNewEmailModal: PropTypes.bool.isRequired,
