              ...
              <div className="bg-white flex flex-col xl:flex-row items-center gap-3 lg:gap-6 py-3 px-3 lg:px-6 rounded-lg">
                ...
                <div className="w-full flex flex-col xl:flex-row items-center xl:justify-center gap-6 xl:gap-20">
                  ...
                  <div className="flex items-center gap-2 justify-center flex-col sm:flex-row xl:flex-col 0px]">
                    <div className="flex items-center justify-center px-26 bg-[#ebf1ff] cursor-pointer py-2 text-[#333333] font-medium gap-2 rounded-md  ">
                      <p className="text-nowrap text-sm lg:text-base">Accept</p>
                    </div>
                    <div className="flex items-center justify-center cursor-pointer px-26 font-medium bg-white border border-[#f2f2f2] shadow-sm py-2 text-[#ea4334] gap-2 rounded-md  ">
                      <p className="text-sm lg:text-base">Decline</p>
                    </div>
                  </div>
                </div>
              </div>
